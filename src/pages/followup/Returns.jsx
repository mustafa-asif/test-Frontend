...
import { ReturnCard } from "../../components/followup/ReturnCard";
...
function ReturnsPage(props) {
  ...
  return (
    <DocumentsManager
      model="purges"
      initialFilters={{ keyword: "", status: "pending", from_date: null, to_date: null, supportRating: "all", supportCategory: "all", supportSubCategory: "all", warehouse: "all" }}
