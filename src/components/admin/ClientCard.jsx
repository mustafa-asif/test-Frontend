    ...
    <Card>
      <div className="grid grid-cols-4 gap-2">
        ...
        <div className="col-span-4 flex items-center gap-x-2">
          ...
          {client.assigned_followup && (
            <span className="h-6 w-max px-2 rounded-full bg-gray-50 text-sm text-green-500 border border-solid border-green-100 flex gap-x-1 items-center justify-center">
